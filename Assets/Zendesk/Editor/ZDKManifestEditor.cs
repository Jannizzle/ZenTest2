...
namespace ZendeskSDK
{
	public class ZDKManifest
	{
		...
		public static bool CheckAndFixManifest()
		{
			...
			{
				Debug.LogError(string.Format("{0} activity is missing from your android manifest. Add \"<meta-data android:name=\"unityplayer.ForwardNativeEventsToDalvik\" android:value=\"true\" />\" to your activity tag so that Zendesk can display.", unityNativeActivityName));
				return false;
			}

			// TODO: Decide what min version is for Zendesk, uses 9 currently but this is from another project.
